...
- 📚 **结构化知识库**：`docs/context/INDEX.md` 五分类表格索引 + `/reflect` 技能自动扫描未索引经验并追加，团队知识持续积累不丢失。
...
│   │   ├── scripts/hooks/            # check-console-log.js, check-hardcoded-styles.js, session-start.js, session-stop.js
...
│   ├── skills/                  # /prd, /progress, /reflect, /C-startup 技能定义
